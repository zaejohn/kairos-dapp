...
| User positions, voting power, rewards | Applicable with privacy and custody redesign | Local opening preview and wallet-scoped saved public commitment receipts exist. Stake-weighted voting, unstaking, and claimable yield are deferred until owner authorization, custody, rewards, and linkability are sound. |
