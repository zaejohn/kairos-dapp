...
| --- | --- | --- |
| 1 | Compact 0.31.1 compiled seven Kairos circuits; seven contract tests passed; the local proof server generated proofs for all seven with synthetic inputs; generated `contracts/managed/kairos` is present locally; README describes the idea and privacy boundary. | Finalized Preview/Preprod deployment and visible address; owner-provided manual screenshots; meaningful milestone history and public repository evidence. |
